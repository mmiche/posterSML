...
No. Just like a t-Test is a single tool in the toolkit of the 'General Linear Model' (GLM), SML is more of a toolkit ('[Mathematical Optimization](https://web.stanford.edu/group/sisl/k12/optimization/#!index.md "Mathematical Optimization")'), not a single tool.
